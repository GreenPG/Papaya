...
var articles : [Article] = [
    ...
    Article(name: "Fiche : Réussissez la plantation...",
            imageName: "soilAB",
            description: "Une plante bien installée dès le départ développera un système racinaire puissant, lui permettant de mieux résister aux aléas climatiques et aux maladies.",
            isLiked: false,
            isSaved: false),
