    ...
    var body: some View {
        ...
        NavigationStack {
                            ...
                            VStack (spacing: 16){
                                ...
                                .sheet(isPresented: $showModal) {
                                    NavigationStack {
                                        ShopCardView(
                                            user: users[1]
                                        ) // par defaut, scroll vers le bas pour faire disparaitre la modale
                                    }
                                }
                            }
            ...
            .toolbarBackground(
                .hidden,
                for: .navigationBar
            ) // permet de rendre transparent une toolbar (a preciser dans le for sinon error) notamment utile ici pour le scroll
        }
    }
}
